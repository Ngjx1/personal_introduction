const PANELS = {
  ...
  projects: {
    ...
    html: `
      ...
      <div class="bento-card" style="--glow:rgba(124,111,240,0.35);">
        ...
        <p class="bento-desc">Visual-only emotion recognition SaaS using CNNs for real-time webcam & static photo analysis. WebSocket live video pipeline, analytics dashboard with auto-generated CSV/Excel/PDF reports, JWT auth, bcrypt hashing, and role-based access control.</p>
        <div class="tech-row">
  ...
  skills: {
    ...
    html: `
      ...
      <div class="section-label">Web & Database</div>
      <div class="skill-grid">
        <span class="skill-badge"><span class="si">🌐</span>HTML/CSS</span>
        <span class="skill-badge"><span class="si">✨</span>JavaScript</span>
        <span class="skill-badge"><span class="si">⚛️</span>React / Next.js</span>
        <span class="skill-badge"><span class="si">🗄️</span>MySQL / PL/SQL</span>
        <span class="skill-badge"><span class="si">⚡</span>Supabase / FastAPI</span>
      </div>
  ...
  contact: {
    ...
    html: `
      ...
      <div class="contact-links">
        <a href="mailto:ngjingxu1@gmail.com" class="btn btn-primary">✉️ email me</a>
...
CLUSTERS.forEach((def, index) => {
  ...
  textMesh.font = 'https://fonts.gstatic.com/s/spacegrotesk/v15/V8mQoQDjQSkGpu8pnHXFAA7sjZtx9Q.woff2';
  ...
  teaserMesh.font = 'https://fonts.gstatic.com/s/spacegrotesk/v15/V8mQoQDjQSkGpu8pnHXFAA7sjZtx9Q.woff2';
